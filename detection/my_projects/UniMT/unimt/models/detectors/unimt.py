...
class UniMTDetector(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(UniMTDetector, self).__init__(**kwargs)
    ...
    def init_weights(self):
        ...
        super(UniMTDetector, self).init_weights()
    ...
    def extract_pts_feat(self, pts, img_feats, img_metas):
        ...
        x, img_feats = self.pts_middle_encoder(voxel_features, coors, batch_size, img_feats, img_metas)
    ...
    def extract_feat(self, points, imgs, img_metas):
        ...
        pts_feats, img_feats = self.extract_pts_feat(points, img_feats, img_metas)
