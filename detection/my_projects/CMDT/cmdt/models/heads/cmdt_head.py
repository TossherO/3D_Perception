...
class CmdtHead(BaseModule):
    ...
    def forward(self, pts_feats, img_feats, img_metas):
        ...
        outs_dec = self.transformer(query, query_pos, pts_feat, pts_pos, img_feat, img_pos, reference_points, 
                                    torch.tensor(self.pc_range).to(pts_feat.device), img_metas, attn_masks=attn_mask)
